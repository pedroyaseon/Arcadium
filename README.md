...
### v0.6.2 — Detalhes e mídia

- [x] reorganizar a página de detalhes para aproveitar janelas desktop amplas;
- [x] destacar informações, atividade, galeria e perfil de execução;
